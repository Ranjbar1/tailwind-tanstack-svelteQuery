...
<div>
	...
	>
		...
		<div class="uppercase flex justify-end gap-5 items-center w-[16%]">
			<!-- Linkedin -->
			<a
				href="https://www.linkedin.com/in/abolfazl--ranjbar?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B7%2Bmgw%2FCyQ72Z%2FV7QHqoUDw%3D%3D"
			>
				<svg
			...
			<!-- Github -->
			<a href="https://github.com/Ranjbar1">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="h-5 w-5"
					fill="currentColor"
